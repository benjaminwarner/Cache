...
public class CacheSimulator {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> words = new ArrayList<String>(Arrays.asList("this", "words", "very", "big", "many", "words",
				"this", "tiny", "testing", "words", "can", "be", "very", "hard", "this", "may", "be", "very", "easy"));
